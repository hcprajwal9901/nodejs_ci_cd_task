...
export const PROJECTS: Project[] = [
  ...
  {
    id: 2,
    title: "Face Detection System for Home Security",
    description: "Developed a face detection system for home security using computer vision techniques. Implemented real-time video processing and facial recognition through CCTV input with high accuracy.",
